...
/**
 * Modèle qui représente une armoire à vin dans laquelle on peut mettre des
 * bouteilles de vin.
 *
...
public class Armoire {
     ...
     * @param nbreMaxBouteilles le nombre maximum de bouteilles que cette nouvelle
     *                          armoire pourra stocker
     */
     ...
     *
     * @return vrai si et seulement si il n'y a plus de place pour rajouter une
    ...
    /**
     * Tente d'ajouter une bouteille à la liste des bouteilles de cette armoire.
     * Chaque armoire à une taille différente
     * et ne peux accueillir qu'un nombre limité de bouteilles défini lors de sa
     * création.
     *
     * @param bouteille bouteille à ajouter
     * @return vrai si et seulement si une bouteille est fournie et qu'il y avait
    ...
    /**
     * Tente de supprimer une bouteille de la liste des bouteilles de cette armoire.
     * Si celle-ci est trouvée, la place
     * que cette bouteille occupait sera désormais libre pour une autre bouteille.
     *
     * @param bouteille bouteille à supprimer
     * @return vrai si et seulement si une bouteille est fournie et que celle-ci a
     *         été trouvée dans cette armoire
     */
    ...
    /**
     * Produit une liste de toutes les bouteilles présentes dans cette armoire sans
     * "trous" (pas de cellules vides).
     *
    ...
    /**
     * Calcule diverses statistiques sur cette armoire et les retourne sous forme
     * d'un bean Statistique. Parmi ces
     * information retournées on trouve la bouteille la plus chère dans cette
     * armoire, la bouteille la moins chère dans
     * cette armoire, le nombre de bouteilles dans cette armoire et le prix moyen
     * des bouteilles de cette armoire.
     *
