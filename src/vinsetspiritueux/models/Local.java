...
/**
 * Modèle qui représente un local d'entreposage dans lequel on peut placer des
 * armoires à vin.
 *
...
public class Local {
    ...
    /**
     * Le constructeur de la classe Local. Toujours initialiser TOUS les attributs !
    ...
    /**
     * Ajoute une armoire à la liste des armoires de ce local. Le succès est garanti
     * : cette méthode n'échoue jamais
     * dans sa tâche ! Pour parvenir à toujours être en mesure de rajouter une
     * armoire dans la liste d'armoires de ce
    ...
    /**
     * Supprime une armoire de la liste des armoires de ce local. Cette méthode ne
     * laissera pas traîner une position
     ...
     * @return vrai si et seulement si cette armoire était présente dans la liste
     *         des armoires de ce local
     */
    ...
    /**
     * Calcule diverses statistiques sur ce local et les retourne sous forme d'un
     * bean Statistique. Parmi ces
     * information retournées on trouve la bouteille la plus chère dans ce local, la
     * bouteille la moins chère dans ce
     * local, le nombre de bouteilles dans ce local et le prix moyen des bouteilles
     * de ce local.
     *
